...
def strip_citation_markers(text: str) -> str:
    # Убираем только явные markdown-цитаты вида [1], [1, 2], [12,3].
    # Прежняя эвристика вырезала цифры после знаков препинания и после букв,
    # но так же удаляла реальные годы, суммы и номера дел (например: «...в 2023.»).
