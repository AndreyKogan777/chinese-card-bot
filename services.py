...
COMBINED_INSTRUCTION = (
    ...
    "WeChat, ассоциации, сертификаты, логотипы. Затем на основе распознанных данных "
    "выполни поиск в интернете и подготовь полный аналитический отчёт по следующей структуре:\n\n"
